                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "currency-exchange.p.rapidapi.com" },
            ...
            using (var response = await client.SendAsync(request))
            {
                ...
                ViewBag.UsdToTry = Decimal.Parse(body.Replace(".", ",")).ToString("0.00");
            }
            #endregion
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "currency-exchange.p.rapidapi.com" },
            ...
            using (var response2 = await client2.SendAsync(request2))
            {
                ...
                ViewBag.EurToTry = Decimal.Parse(body2.Replace(".", ",")).ToString("0.00");
            }
            #endregion
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "currency-exchange.p.rapidapi.com" },
            ...
            using (var response3 = await client3.SendAsync(request3))
            {
                ...
                ViewBag.GbpToTry = Decimal.Parse(body3.Replace(".", ",")).ToString("0.00");
            }
            #endregion
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "currency-exchange.p.rapidapi.com" },
            ...
            using (var response4 = await client4.SendAsync(request4))
            {
                ...
                ViewBag.UsdToEur = Decimal.Parse(body4.Replace(".", ",")).ToString("0.00");
            }
            #endregion
            return View();
        }
